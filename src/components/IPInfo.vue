<template>
  <div
    class="absolute -bottom-64 lg:-bottom-20 flex flex-col lg:flex-row bg-white gap-y-4 gap-x-12 px-8 pt-8 pb-8 rounded-md"
  >
    <!-- Flex Item #1 -->
    ...
    <!-- Flex Item #3 -->
    <div class="flex flex-col">
      <h3 class="text-xs mb-2 uppercase">Time Zone</h3>
